...
import { TitleContainer, TextBodyLarge, DetailsProduct, TextBodySmall } from './../../styles/generalComponents'
import { TextBodySmallStyled, DetailsProductStyled, DetailsContainer } from './styles/sSummaryPucharse.js'
  ...
  return (
    <div>
      ...
      <DetailsContainer>
        ...
        <DetailsProduct detailsPrices>
          <TextBodySmallStyled wMediumDetailsPrice>Subtotal <span>({numberOfArticles === 1 ? "1 artículo": `${numberOfArticles} artículos`})</span></TextBodySmallStyled>
        ...
        <DetailsProduct detailsPrices>
          ...
          <TextBodySmallStyled>PEN <span>{discount}</span></TextBodySmallStyled>
        </DetailsProduct>
        <DetailsProduct detailsPrices>
          <TextBodySmallStyled>Costo de envío</TextBodySmallStyled>
          <TextBodySmallStyled><span>Gratis</span></TextBodySmallStyled>
        </DetailsProduct>
