...
import { nameValidator, lastNameValidator, phoneNumberValidator, addressValidator,
         cityValidator, stateValidator, postalCodeValidator, emailValidator } from './objects/formValidators'

const MainAddAdress = () => {
  const history = useHistory()
  const {register, formState: { errors }, handleSubmit} = useForm()
  const {setAddressOfUser} =  useContext(AppContext)
